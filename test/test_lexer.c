...
static int test_newtokencmd(char *str, enum token_type type,
			    enum token_type_spec spec)
{
...
static int test_newtoken(char *str, enum token_type type,
			 enum token_type_spec spec)
{
...
static int test_lexline(char *line, char **d, enum token_type *t,
